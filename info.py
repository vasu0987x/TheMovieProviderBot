...
PICS = (environ.get('PICS', 'https://envs.sh/6vm.jpg https://envs.sh/6vM.jpg https://envs.sh/6vX.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/6vX.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/85d361ab4cb6511006022.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/6vM.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/6vm.jpg'))
CODE = (environ.get('CODE', 'https://envs.sh/6vm.jpg'))
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7658557284').split()]
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : vasu')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002038476381')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+dB6TlOJsfXJlODA1') #Support group link ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002038476381'))
